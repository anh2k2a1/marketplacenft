...
export const Footer: FC = () => {
  ...
  const menuTwo = ["Press Imquiries", "Social Media Support", "Image & B-Roll", "Site Map"]
  return (
            ...
            <ul className='flex flex-col gap-3'>
              ...
              </h5>
              {
                menuTwo.map((item, index) => (
                  <li key={index}>
                    <a href="#" className=' items-center text-default-400
                      text-base transition-all
                      hover:text-white py-2 w-full'>
                      <i data-licide="gauge-circle" className='me-2 inline-block h-4 w-4'>
                      </i>
                      {item}
                    </a>
              ...
              <div className='p-10'>
                ...
                <form onSubmit={handleSubmit} className='mb-6 space-y-2'>
                  ...
                  <div className='relative'>
                    <input type="email" name="email" id="email"
                      className='bg-default-950/60 pe-40 ps-4 h-12 w-full 
                      rounded-lg border-white/10 py-4 text-white 
                      backdrop-blur-3xl focus:border-white/10 focus:ring-0' />
                    <button type='submit' disabled={state.submitting} className='hover:bg-primary-hover hover:
                      border-primary-hover border-primary bg-primary end-[6px] absolute top-[6px] 
                      inline-flex h-9 items-center justify-center gap-2 rounded-mb rounded-md px-6 text-white transition-all'>
                      Subsribe
                    </button>
                  </div>
                </form>
                <div>
                  ...
                  <ul className='flex flex-wrap items-center gap-1'>
                    {
                      [< TiSocialFacebook />, <TiSocialLinkedin />, <TiSocialTwitter />, <TiSocialYoutube />].map((item, index) => (
                        <li key={index}>
                          <a href="#"
                            className='hover:bg-primary group inline-flex h-10 w-10 items-center
                            justify-center rounded-lg border border-white/10 transition-all duration-500'>
                            <i data-lucide="facebook" className='text-default-300 group-hover:text-center'>
                              {item}
                            </i>
                          </a>
                        </li>
